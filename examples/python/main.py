"""
Example: How to call the azoramoon-com-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/azoramoon-com-scraper
...
def run_actor():
    """Run the azoramoon-com-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/azoramoon-com-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://azoramoon.com/page/2/"}],
            "maxItems": 10,
        }
    )
